    ...
    return jsonify({
        ...
        "paths": {
            ...
            "/socios/{socio_id}/planos-treino": {
                ...
                "post": {"summary": "Criar plano de treino", "tags": ["Planos de Treino"], "parameters": [{"name": "socio_id", "in": "path", "required": True, "schema": {"type": "string"}}], "requestBody": {"required": True, "content": {"application/json": {"schema": {"type": "object", "required": ["nome","nivel","exercicios"], "properties": {"nome": {"type": "string"}, "nivel": {"type": "string", "enum": ["INICIANTE","INTERMEDIO","AVANCADO"]}, "exercicios": {"type": "array", "items": {"type": "object"}, "example": [{"nome": "rosca direta","series": 2,"repeticoes": 12,"descanso_segundos": 40,"tipo": "FORCA|CARDIO|FLEXIBILIDADE|FUNCIONAL"}]}}}}}}, "responses": {"201": {"description": "Criado"}}}
            },
